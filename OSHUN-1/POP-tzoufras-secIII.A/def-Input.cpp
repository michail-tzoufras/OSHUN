...
//      Parallel
        NnodesX = 64; NnodesY = 1; 

//      spherical harmonics (assumed l0 > 3, m0 > 1, l0 >= m0)
        l0 = 31;   m0 = 2; 
        nump = 432; numx_glob = 192; numy_glob = 2;

        xmin = -39880.82246;  //  -400um
        xmax =  39880.82246;  //   400um
        ymin = -1000.0;  //  -400um
        ymax =  1000.0;  //   400um
...
//      Restat files
        ...
        n_restarts = 6;   // generate "n_restarts" restart files
...
//      Electron-ion collision parameters
        lnLambda = 10.3; Zeta = 2.0;

//      Density
        density_np = 4.5e+20;// in 1/cm^3
...
//      Density profile
        ...
        xloc.push_back(   -39880.82246 );   xdens.push_back(   1.00  ); 
        ...
        yloc.push_back( -1000.000); ydens.push_back(   1.0  ); 
 ...
 //     Temperature profile
        ...
        xtloc.push_back(  -49880.82246 );   xtemp.push_back(   0.04421);  
        xtloc.push_back(   -780.328 );  xtemp.push_back(   0.04421);  
        xtloc.push_back(   -90.48 );   xtemp.push_back(   0.04421);  
        xtloc.push_back(         0.0 );    xtemp.push_back(   0.04421);
        xtloc.push_back(   92.1312 );    xtemp.push_back(   0.04421);   
//        xtloc.push_back(    425.0  );   xtemp.push_back(   0.0313  ); 
        xtloc.push_back(   178.246  );    xtemp.push_back(   0.04421);   // 0.15keV
        xtloc.push_back(   49880.82246 );    xtemp.push_back(  0.04421);   // 0.15keV
        ...
        ytloc.push_back(  -1000.000 );   ytemp.push_back(   1.00  ); 
        ytloc.push_back(  -176.230  );   ytemp.push_back(   1.00  ); 
        ytloc.push_back(  -2.99 );   ytemp.push_back(   1.00  );
        ytloc.push_back(   2.99 );   ytemp.push_back(   1.00  ); 
        ytloc.push_back(   176.230);   ytemp.push_back(   1.00  ); 
        ytloc.push_back(   1000.00 );   ytemp.push_back(   1.00  );
